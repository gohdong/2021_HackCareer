      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            verticalSpacer(220),
            FutureBuilder<User?>(
              future: getMember(widget.userID),
                                  ...
                                  Align(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        verticalSpacer(10),
                                        Text(
                                            "한양대학교 ERICA캠퍼스\n${snapshot.data!.major} ${extractYearOnStudentNumber(snapshot.data!.studentNum)}",
                            ...
                            Positioned(
                              ...
                              child: Container(
                                ...
                                child: Stack(
                                  clipBehavior: Clip.none,
                                  children: [
                                    userProfileImg(147, 147,user: snapshot.data!),
